...
//    public void temiUptime(){
//        System.out.println("start working");
//        System.out.println("start working");
//        System.out.println("start working");
//        //从官网获取
//        String appId = "6xLUZYEZvkMhJaphb5FBGhHNfqZDZUpBd5b7BuhV2pau";
//        String sdkKey = "ARe8YTRj66xwMFBjzSbcxYceZhVi2cUTRfEfC3etNKgj";
//
//
...
//        if (errorCode != ErrorInfo.MOK.getValue() && errorCode != ErrorInfo.MERR_ASF_ALREADY_ACTIVATED.getValue()) {
//            System.out.println("获取激活文件信息失败22222");
//        }
//
//        //引擎配置
...
//            System.out.println("初始化引擎失败23333");
//        }
//
//
//        //人脸检测
//        ImageInfo imageInfo = getRGBData(new File("D:\\lib\\aaa.jpg"));
...
//
//        //人脸检测2
//        ImageInfo imageInfo2 = getRGBData(new File("D:\\lib\\aaa.jpg"));
...
//
//        //IR属性处理
//        ImageInfo imageInfoGray = getGrayData(new File("D:\\lib\\aaa.jpg"));
